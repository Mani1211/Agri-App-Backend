...
const cloudDbUri =
  "mongodb+srv://project8:Password*123@project8-ur9cs.mongodb.net/Farm_Machinery_Details?retryWrites=true&w=majority";
...
app.post("/riceincomeupdate/:id", async (req, res) => {
  ...
  let income = await RiceIncome.findByIdAndUpdate(
    req.params.id,
    {
      date: req.body.date,
...
app.post("/riceexpenseupdate/:id", async (req, res) => {
  console.log(req.body, req.params.id);
  let expense = await RiceExpense.findByIdAndUpdate(
    req.params.id,
    {
...
app.post("/sugarexpenseupdate/:id", async (req, res) => {
  console.log(req.body, req.params.id);
  let expense = await SugarExpense.findByIdAndUpdate(
    req.params.id,
    {
      driverName: req.body.driverName,
      managerName: req.body.managerName,
...
app.post("/balerrentincomeupdate/:id", async (req, res) => {
  console.log(req.body, req.params.id);
  let income = await BalerRentIncome.findByIdAndUpdate(
    req.params.id,
    {
      date: req.body.date,
      customerPlace: req.body.customerPlace,
...
app.post("/balersellincomeupdate/:id", async (req, res) => {
  console.log(req.body, req.params.id);
  let income = await BalerSellIncome.findByIdAndUpdate(
    req.params.id,
    {
      date: req.body.date,
...
app.post("/balerexpenseupdate/:id", async (req, res) => {
  console.log(req.body, req.params.id);
  let expense = await BalerExpense.findByIdAndUpdate(
    req.params.id,
    {
      driverName: req.body.driverName,
      managerName: req.body.managerName,
